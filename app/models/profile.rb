class Profile < ApplicationRecord
    ...
    def reject_experience_create(experience) # created similar to education
        experience[:job_title].blank? or experience[:company].blank? or experience[:start_date].blank? or experience[:end_date].blank?
    end
end